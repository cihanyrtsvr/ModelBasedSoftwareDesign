###########################################################################
## Makefile generated for component 'controller_arduino_2020b'. 
## 
## Makefile     : controller_arduino_2020b.mk
## Generated on : Sat Jun 03 12:33:41 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/controller_arduino_2020b.elf
...
PRODUCT_NAME              = controller_arduino_2020b
MAKEFILE                  = controller_arduino_2020b.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/user/Desktop/CIHANP~1/2E2B9~1.YEA/MODEL-~1/2023/Labs/LAB4~1/Example
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controller_arduino_2020b.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/ert/controller -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/controller_arduino_2020b_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=controller_arduino_2020b -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o controller_arduino_2020b.o controller_arduino_2020b_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) ../slprj/ert/controller/controller_rtwlib.a $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
controller_arduino_2020b.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/controller_arduino_2020b.c
	$(CC) $(CFLAGS) -o "$@" "$<"


controller_arduino_2020b_data.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/controller_arduino_2020b_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/controller_arduino_2020b_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
